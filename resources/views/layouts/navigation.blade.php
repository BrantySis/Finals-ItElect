<nav x-data="{ open: false }" class="bg-white border-b border-gray-100 dark:bg-gray-800 dark:border-gray-700">
            ...
            <div class="flex">
                ...
                <div class="flex items-center space-x-3 shrink-0">
                    ...
                    <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                        ...
                        <x-nav-link :href="route('tenants.index')" wire:navigate :active="request()->routeIs('tenants.index')">
                            {{ __('Tenants') }}
                        </x-nav-link>
                        <x-nav-link :href="route('tenants.payments')" wire:navigate :active="request()->routeIs('tenants.payments')">
                            {{ __('Payments') }}
                        </x-nav-link>
                    </div>
            </div>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('tenants.index')" wire:navigate :active="request()->routeIs('tenants.index')">
                {{ __('Tenants') }}
            </x-responsive-nav-link>
        </div>
